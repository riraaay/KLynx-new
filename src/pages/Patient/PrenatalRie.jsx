                  ...
                  <div className='inputs'>
                      <label htmlFor="note-record">Nurse/Midwife Notes</label>
                          <select name="note-record"  required > 
                            <option hidden></option>
                              <option value="opt1" id='opt1'>Pregnant woman with at least 4 prenatal check ups</option>
                              <option value="opt2" id='opt2'>Pregnant woman assesed of their nutritional normal BMI</option>
                              <option value="opt3" id="opt3">Low BMI</option>
                              <option value="opt4" id='opt4'>High BMI</option>
                              <option value="opt5" id='opt5'>Pregnant Woman for the first Time given at least 2 doses</option>
                              <option value="opt6" id='opt6'>At least 3 doses of Td vaccination (Td2 Pplus)</option>
                              <option value="opt7" id='opt7'>Folic Acid supplementation</option>
                              <option value="opt8" id='opt8'>Carbonate supplementation</option>
                              <option value="opt9" id='opt9'>Pregnant Woman given iodine capsules</option>
