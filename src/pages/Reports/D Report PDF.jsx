...
export function generatePDF({ title, monthYear, tableHeaders, tableData, logo }) {
  ...
  function drawContent() {
    ...
    doc.text('Generated by Medika System | Timezone: Asia/Manila', marginLeft, doc.internal.pageSize.height - 11);
    doc.text('© 2025 Karangalan Health Center', marginLeft, doc.internal.pageSize.height - 7);
    doc.text('Municipality of Cainta, Rizal', marginLeft, doc.internal.pageSize.height - 3);
