	 ...
	 <header className="header">
      ...
      {showTerms && (
        ...
        <div className='upcomingAppt'>
            ...
            <div className='upAppt'>
                <h4>Coleen Sanchez</h4>
                <h3>Dr. Prudente, Anthony</h3>
                    <h5>Check Up</h5>
                <div><h5>1:00 PM - 3:00 PM</h5>

                <button className='upcomingAppt-btn'> Accept</button>
                <button className='upcomingAppt-btn'>Decline</button>
                </div>
            </div>
