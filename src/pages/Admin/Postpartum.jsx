            ...
            <form className="record-form" onSubmit={handleFormSubmit}>
              <div className='inputs-column'>
                ...
                <div className='inputs-column'>
                  ...
                  <div className='inputs'>
                      <label htmlFor="note-record">Nurse/Midwife Notes</label>
                          <select name="note-record"  required > 
                            <option hidden></option>
                              <option value="opt1" id='opt1'>Completed at least 2 postpartum check-ups</option>
                              <option value="opt2" id='opt2'>Acid Supplementation</option>
                              <option value="opt3" id="opt3">Supplementation</option>
                              <option value="opt4" id='opt4'>Diagnosed with Hypertension</option>
                              <option value="opt5" id='opt5'>Pregnant Woman who gave birth who have access to the closest birthing facility within 2 hrs</option>
                              <option value="opt6" id='opt6'>Delivery with 4 ANC</option>
                              <option value="opt7" id='opt7'>Delivery with 1 ANC during 1st trimester</option>
                              <option value="opt8" id='opt8'>Woman who gave birth for the 1st time</option>
                              <option value="opt9" id='opt9'>Woman who gave birth who are grand multigravida (GS & above)</option>
                              <option value="opt10" id='opt10'>Pregnant Woman given one dose of deworming tablet</option>
                              <option value="opt11" id='opt11'>Pregnant Woman Tested for syphilis</option>
                              <option value="opt12" id='opt12'>Pregnant Woman Tested Positive</option>
                              <option value="opt13" id='opt13'>Pregnant Woman Screened for Hepatitis B</option>
                              <option value="opt14" id='opt14'>Pregnant Woman Tested Positive</option>
                              <option value="opt15" id='opt15'>Pregnant Woman Screened for HIV</option>
                              <option value="opt16" id='opt16'>Pregnant Woman Tested for CBC of hgB and hct count</option>
                              <option value="opt17" id='opt17'>Diagnosed anemia</option>
                              <option value="opt18" id='opt18'>Pregnant Woman screened for gestational diabetes</option>
                          </select>    
                  </div>
            </form>
