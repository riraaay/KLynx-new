...
function Doctors() 
{
  ...
  const handleAddDoctorsSubmit = (e) =>{
    ...
    const handleEditSubmit = (e) =>{
        ...
        axios.put(`http://localhost/api/Doctors.php?id=${selectedDoctor.UserID}`, selectedDoctor).then(function(response){
            console.log(response.data);
            getDoctorsList();
            setSelectedDoctor(null);
...
//   };
  ...
  return (
    <div className="container">
      ...
      {showTerms && (
        ...
        <div className="contents">
          <div className="patrec-btn">
            ...
            <p className="EntriesName">Entries</p>
        ...
        <div className="table-container">
          <table className="table-cont">
            ...
            {doctorsList.map((doctorsL, key) => (
                <tr key={key}>
                  <td>{doctorsL.UserID}</td>
                  <td>{doctorsL.LastName}</td>
                  <td>{doctorsL.FirstName}</td>
                  <td>{doctorsL.MiddleName}</td>
                  <td>{doctorsL.EmailAddress}</td>
                  <td>{doctorsL.ContactNumber}</td>
                  <td><button onClick={() => viewDoctor(doctorsL.UserID) }>View</button></td>
                  <td><button onClick={() => editDoctor(doctorsL.UserID) } style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0 }} title="Edit" >
                  <i className="fa-solid fa-pen-to-square" style={{ color: '#003399' }} ></i>  </button></td>
                  <td><button onClick={() => { /*deleteDoctor(doctorsL.UserID)*/ setSelectedDoctor(doctorsL.UserID); setDeleteDoctorModal(true); } } style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0 }} title="Delete" >
                  <i className="fa-solid fa-trash-can" style={{ color: '#003399' }} ></i>  </button></td>
      ...
      {/* WINDOW THAT SHOWS THE 'ADD BUTTON' OF DOCTORS */}
      {showModal   && (
            ...
            <div className="add-doctors-popup-content">
                ...
                <form className="add-doctors-form" onSubmit={handleAddDoctorsSubmit}>
                    ...
                    <div className="add-doctors-column">
                        ...
                        <div className="add-doctors-input-box">
                            <label htmlFor="add-doctors-userID">User ID:</label>  
                            <input type="text" id="add-doctors-userID" name="uID" placeholder="Enter your user id" required onChange={handleAddDoctorsChange} />
                        </div>
                    </div>
                    <div className="add-doctors-column">
                        <div className="add-doctors-input-box">
    ...
    {/* WINDOW THAT SHOWS 'VIEW BUTTON' OF DOCTORS */}
            ...
            <div className="add-doctors-popup-content">
                ...
                <form className="add-doctors-form" onSubmit={handleAddDoctorsSubmit}>
                    ...
                    <div className="add-doctors-column">
                        ...
                        <div className="add-doctors-input-box">
                            <label htmlFor="add-doctors-userID">User ID:</label>  
                            <input type="text" id="add-doctors-userID" name="uID" className="add-doctors-shaded-input" readOnly value={selectedDoctor.UserID} />
                        </div>
                    </div>
                    <div className="add-doctors-column">
                        <div className="add-doctors-input-box">
    ...
    {/* WINDOW THAT SHOWS 'EDIT BUTTON' OF DOCTOR */}
